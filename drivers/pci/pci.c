...
/**
 * pci_find_capability - query for devices' capabilities 查询设备的能力
 * @dev: PCI device to query  查询哪个pci设备
 * @cap: capability code 哪种能力。
 *
 * Tell if a device supports a given PCI capability. 
 告诉我们设备是否支持pci的某一个能力
 * Returns the address of the requested capability structure within the
 返回请求能力结构的地址。
 pci设备配置空间的地址，如果不支持返回0.
 ...
 */
static int pci(struct pci_dev *pdev, int bar,
